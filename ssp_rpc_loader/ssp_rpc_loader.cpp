// ssp_rpc_loader.cpp : 定义控制台应用程序的入口点。
//
...
int main(int argc, char **argv) {
	...
	printf("\n-------------------\nSave Path: C:\\ProgramData\\dump.bin\n-------------------\n");
	
	if (argc != 2) {
		printf("Usage: this.exe PACKAGE_PATH\n");
		printf("Usage: this.exe C:\\sspdll.dll\n");
		return 1;
	}	
	...
	//mbstowcs_s(&temp, (wchar_t*)(rpcPacket + 0xd8), 1, argv[1], (sizeof(rpcPacket) - 0xd8) / 2);
